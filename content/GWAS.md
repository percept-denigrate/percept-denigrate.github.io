...
This issue is circumvented by within-family GWAS, that only look at the relative frequencies of SNPs within families (by looking at the deviation from parents or siblings mean). This effectively controls for stratification.
